import pandas as pd
import os
from global_variables import LIST_CLASSES, TRAIN_SLIM_FILENAME, LIST_LOGITS
import numpy as np
...
def find_good_predicts(valids, toxic_column):
    ...
    b1 = valids[toxic_column] > 0.999
    b2 = valids[toxic_column] < 0.01
    c = valids[b1|b2]
...
train_e0 = pd.concat([train,good_predictions], axis= 0,)
