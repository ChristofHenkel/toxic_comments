...
inception5b = pd.read_csv('models/CNN/inception5b/l2_test_data.csv') #0.9833
...
blend_l0_1['toxic'] = lgb_public['toxic'] * 0.15 + gru_public['toxic'] * 0.4 + lr['toxic'] * 0.15 + lstm_nb_svm['toxic'] * 0.3
blend_l0_1['severe_toxic'] = lgb_public['severe_toxic'] * 0.15 + gru_public['severe_toxic'] * 0.4 + lr['severe_toxic'] * 0.15 + lstm_nb_svm['severe_toxic'] * 0.3
blend_l0_1['obscene'] = lgb_public['obscene'] * 0.15 + gru_public['obscene'] * 0.4 + lr['obscene'] * 0.15 + lstm_nb_svm['obscene'] * 0.3
blend_l0_1['threat'] = lgb_public['threat'] * 0.15 + gru_public['threat'] * 0.4 + lr['threat'] * 0.15 + lstm_nb_svm['threat'] * 0.3
blend_l0_1['insult'] = lgb_public['insult'] * 0.15 + gru_public['insult'] * 0.4 + lr['insult'] * 0.15 + lstm_nb_svm['insult'] * 0.3
blend_l0_1['identity_hate'] = lgb_public['identity_hate'] * 0.15 + gru_public['identity_hate'] * 0.4 + lr['identity_hate'] * 0.15 + lstm_nb_svm['identity_hate'] * 0.3
...
blend_l1_1[LIST_CLASSES] = 0.2 * minmax_scale(blend_l0_1[LIST_CLASSES].values) + 0.42 * gru_ATT_4[LIST_CLASSES].values + 0.18 * inception5b[LIST_CLASSES].values + 0.2 * sup[LIST_CLASSES].values
blend_l1_1.to_csv("blends/blend4/submission.csv", index=False)
